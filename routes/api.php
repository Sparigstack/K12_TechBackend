...
Route::get('/openTickets/{sid?}&{key}&{skey}', [ManageTicketController::class, 'OpenTickets']);
Route::get('/closeTickets/{sid?}&{key}&{skey}', [ManageTicketController::class, 'CloseTickets']);
